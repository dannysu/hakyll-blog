...
---
The designer I work with passed around some videos of the deal in iPhone app on Monday. This particular video demonstrates a kind of fold effect as the user pan horizontally across the screen: <a href="http://vimeo.com/41495357" target="_blank">http://vimeo.com/41495357</a>
...
<ol>
	<li>Convert UIView into an image</li>
	<li>Split resulting image into 2 vertical halves</li>
	<li>Tint the right image slightly</li>
	<li>Use Core Animation to rotate left image one way anchored on left side and rotate right image the other way but anchored on the right side</li>
</ol>
Here's a video of my results: <a href="http://www.dannysu.com/wp-content/uploads/2012/05/foldeffect.mov" target="_blank">foldeffect</a>

&nbsp;

Code below. I had help from this <a href="https://github.com/rbreve/Flipboard-3D-Transform-Effect-Example" target="_blank">Flipboard example</a> showing how to use Core Animation.
<pre escaped="true" lang="objc">- (void)pan:(UIPanGestureRecognizer *)gesture {
